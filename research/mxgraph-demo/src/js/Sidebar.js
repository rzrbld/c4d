		...
		this.addEntry(dt + 'person', mxUtils.bind(this, function()
		   {
			...
			bg.setValue('<font style="font-size: 16px"><b>Person name</b></font><div>[Person]</div><br><div><font style="font-size: 11px"><font color="#cccccc">Description of person.</font></div>');
		...
		this.addEntry(dt + 'external person', mxUtils.bind(this, function()
		   {
			...
			bg.setValue('<font style="font-size: 16px"><b>External person name</b></font><div>[Person]</div><br><div><font style="font-size: 11px"><font color="#cccccc">Description of external person.</font></div>');
		...
		this.addEntry(dt + 'software system', mxUtils.bind(this, function()
		   {
			...
			bg.setValue('<font style="font-size: 16px"><b>System name</b></font><div>[Software System]</div><br><div><font style="font-size: 11px"><font color="#cccccc">Description of software system.</font></div>');
		...
		this.addEntry(dt + 'external software system', mxUtils.bind(this, function()
		   {
			...
			bg.setValue('<font style="font-size: 16px"><b>External system name</b></font><div>[Software System]</div><br><div><font style="font-size: 11px"><font color="#cccccc">Description of external software system.</font></div>');
		...
		this.addEntry(dt + 'container', mxUtils.bind(this, function()
		   {
			...
			bg.setValue('<font style="font-size: 16px"><b>Container name</b></font><div>[Container: e.g. SpringBoot, ElasticSearch, etc.]</div><br><div><font style="font-size: 11px"><font color="#E6E6E6">Description of container role/responsibility.</font></div>');
		...
		this.addEntry(dt + 'data container', mxUtils.bind(this, function()
		   {
			...
			bg.setValue('<font style="font-size: 16px"><b>Container name</b></font><div>[Container:&nbsp;e.g. Oracle Database 12]</div><br><div><font style="font-size: 11px"><font color="#E6E6E6">Description of storage type container role/responsibility.</font></div>');
		...
		this.addEntry(dt + 'microservice container',  mxUtils.bind(this, function()
		   {
			...
			bg.setValue('<font style="font-size: 16px"><b>Container name</b></font><div>[Container: e.g. Micronaut, etc.]</div><br><div><font style="font-size: 11px"><font color="#E6E6E6">Description of microservice type container role/responsibility.</font></div>');
		...
		this.addEntry(dt + 'message bus container',  mxUtils.bind(this, function()
		   {
			...
			bg.setValue('<font style="font-size: 16px"><b>Container name</b></font><div>[Container: e.g. Apache Kafka, etc.]</div><br><div><font style="font-size: 11px"><font color="#E6E6E6">Description of message bus type container role/responsibility.</font></div>');
		...
		this.addEntry(dt + 'web browser container',  mxUtils.bind(this, function()
		   {
			...
			bg.setValue('<font style="font-size: 16px"><b>Container name</b></font><div>[Container: e.g. JavaScript, Angular etc.]</div><br><div><font style="font-size: 11px"><font color="#E6E6E6">Description of web browser container role/responsibility.</font></div>');
		...
		this.addEntry(dt + 'component', mxUtils.bind(this, function()
		   {
			...
			bg.setValue('<font style="font-size: 16px"><b>Component name</b></font><div>[Component: e.g. Spring Service]</div><br><div><font style="font-size: 11px">Description of component role/responsibility.</font></div>');
			
			   return sb.createVertexTemplateFromCells([bg], bg.geometry.width, bg.geometry.height, 'Component');
		})),				
		this.addEntry(dt + 'relationship description technology', mxUtils.bind(this, function()
		   {
			var sb = this;
			var edge = new mxCell('', 
			...
			edge.setValue('<div style="text-align: left"><div style="text-align: center"><b>e.g. Makes API calls</b></div><div style="text-align: center">[e.g. JSON/HTTP]</div></div>');
		...
		this.addEntry(dt + 'relationship description', mxUtils.bind(this, function()
		   {
			...
			edge.setValue('<div style="text-align: left"><div style="text-align: center;"><b>e.g. Visits pages</b></div></div>');
		...
		this.addEntry(dt + 'relationship', mxUtils.bind(this, function()
		   {
			...
			// edge.setAttribute('placeholders', '1');
			// edge.setAttribute('c4Type', 'Relationship');
			edge.setValue('<div style="text-align: left"><div style="text-align: center">Relationship</div></div>')
		...
		this.addEntry(dt + 'system scope boundary', mxUtils.bind(this, function()
		   {
			...
			bg.setValue('<font style="font-size: 16px"><b><div style="text-align: left">System name</div></b></font><div style="text-align: left">[Software System]</div>');
		...
		this.addEntry(dt + 'container scope boundary', mxUtils.bind(this, function()
		   {
			...
			bg.setValue('<font style="font-size: 16px"><b><div style="text-align: left">Container name</div></b></font><div style="text-align: left">[Container]</div>');
		...
		this.addEntry(dt + 'legend', mxUtils.bind(this, function()
		   {
			...
			var tableEntry3 = new mxCell('Container', new mxGeometry(0, 60, 160, 30), 'shape=partialRectangle;html=1;whiteSpace=wrap;connectable=0;fillColor=#52A2D8;top=0;left=0;bottom=0;right=0;overflow=hidden;pointerEvents=1;align=left;spacingLeft=10;fontColor=#FFFFFF;');
			tableEntry3.vertex = true;
			bg2.insert(tableEntry3);
			var tableEntry4 = new mxCell('Component', new mxGeometry(0, 90, 160, 30), 'shape=partialRectangle;html=1;whiteSpace=wrap;connectable=0;fillColor=#7CBEF1;top=0;left=0;bottom=0;right=0;overflow=hidden;pointerEvents=1;align=left;spacingLeft=10;fontColor=#FFFFFF;');
			tableEntry4.vertex = true;
			bg2.insert(tableEntry4);
			var tableEntry5 = new mxCell('External Person', new mxGeometry(0, 120, 160, 30), 'shape=partialRectangle;html=1;whiteSpace=wrap;connectable=0;fillColor=#6B6477;top=0;left=0;bottom=0;right=0;overflow=hidden;pointerEvents=1;align=left;spacingLeft=10;fontColor=#FFFFFF;');
			tableEntry5.vertex = true;
			bg2.insert(tableEntry5);
			var tableEntry6 = new mxCell('External Software System', new mxGeometry(0, 150, 160, 30), 'shape=partialRectangle;html=1;whiteSpace=wrap;connectable=0;fillColor=#8B8496;top=0;left=0;bottom=0;right=0;overflow=hidden;pointerEvents=1;align=left;spacingLeft=10;fontColor=#FFFFFF;');
...
Sidebar.prototype.addBpmnPalette = function(dir, expand)
{
	...
	[
		...
		// this.createVertexTemplateEntry('shape=mxgraph.kubernetes.c_c_m;', 50, 100, '', 'Lol kek', null, null, this.getTagsForStencil('bpmn', 'annotation_1', 'bpmn business process model ').join(' ')),
